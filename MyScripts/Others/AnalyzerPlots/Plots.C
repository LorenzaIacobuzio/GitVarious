...
void Plots(TString dir, TString histo1, TString histo2) {
  ...
  //TString path = dir + "OneValuePlots/";
  TString path = dir;
  ...
  ParseDir(histo2, "HeavyNeutrinoScan/MassScan", path, c, m, m1);
