...
usage = "%Hadd.py condorpath analyzer1 analyzer2 tree copypath"
...
parser.add_argument("tree", metavar = "tree", type = str, help = "tree name to be kept in the new .root file")
    ...
    for subdir, dirs, files in os.walk(condorpath):
        for file in files:
            if "root" in file and "final" not in file and "new" not in file:
                os.system(copypath + "/copyFiles " + os.path.abspath(os.path.join(subdir, file)) + " " + os.path.abspath(os.path.join(subdir, "new1" + file)) + " " + analyzer1 + " " + tree + "\n")
                print(copypath + "/copyFiles " + os.path.abspath(os.path.join(subdir, file)) + " " + os.path.abspath(os.path.join(subdir, "new1" + file)) + " " + analyzer1 + " " + tree + "\n")
