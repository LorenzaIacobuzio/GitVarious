...
Double_t HeavyNeutrinoCouplingScan::ComputeHNLMass(KinePart* p) {
...
Double_t HeavyNeutrinoCouplingScan::ComputeL(TVector3 p1, TVector3 p2, TVector3 mom1) {
...
Double_t HeavyNeutrinoCouplingScan::ComputeNDecayProb(KinePart* p, Double_t tau, Double_t l) {
...
Double_t HeavyNeutrinoCouplingScan::ComputeNReachProb(KinePart* p, Double_t tau, Double_t l) {
...
Double_t HeavyNeutrinoCouplingScan::PhaseSpace(Double_t Mass1, Double_t Mass2, Double_t Mass3) {
...
Double_t HeavyNeutrinoCouplingScan::PhaseSpaceFactor(Double_t Mass1, Double_t Mass2, Double_t Mass3) {
...
Double_t HeavyNeutrinoCouplingScan::TwoBodyBR(Double_t Mass1, Double_t Mass2, Double_t Mass3, Int_t Dorigin, Bool_t noU) {
...
Double_t HeavyNeutrinoCouplingScan::ThreeBodyBR(Double_t Mass1, Double_t Mass2, Double_t Mass3, Double_t Mass4, Int_t Dorigin, Bool_t noU) {
...
std::string HeavyNeutrinoCouplingScan::ThreeBodyFunction(Double_t Mass1, Double_t Mass3) {
...
Double_t HeavyNeutrinoCouplingScan::Gamma2(Double_t Mass1, Double_t Mass2, Double_t Mass3, Double_t form, Bool_t noU) {
...
Double_t HeavyNeutrinoCouplingScan::GammaLeptonNu3(Double_t Mass1, Double_t Mass2, Double_t Mass3, Bool_t noU) {
...
Double_t HeavyNeutrinoCouplingScan::GammaTot(Double_t MN) {
...
Double_t HeavyNeutrinoCouplingScan::tauN(Double_t MN) {
...
Double_t HeavyNeutrinoCouplingScan::lambda(Double_t a, Double_t b, Double_t c) {
...
Double_t HeavyNeutrinoCouplingScan::ComputeProd(KinePart* p, Double_t MN) {
...
Double_t HeavyNeutrinoCouplingScan::ComputeDecay(Double_t MN) {
