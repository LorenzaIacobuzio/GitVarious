...
/// \Brief                                                                                              
/// Scan on the coupling of heavy neutral leptons to SM leptons. It includes selection, weight and 
/// yield computation as a function of the coupling
/// \EndBrief                                                                                           
/// \Detailed                                                                                           
...
/// acceptance and yield per POT are also computed. Moreover, several histograms of relevant quantities
/// (including acceptance and yield) are produced as functions of the coupling.
