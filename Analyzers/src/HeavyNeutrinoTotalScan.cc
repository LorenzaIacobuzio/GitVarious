					...
					if (Zvertex > 102500. && Zvertex < 180000.) {
					  ...
					  if (CDA1 > 50. && CDA2 > 50.) {
						...
						if (p->GetParentID() == -1 && p->GetPDGcode() == 999 && p->GetEndProcessName() == "good") {
						  ...
						  Weight = DProdProb*fDDecayProb*NReachProb*NDecayProb*DecayFactor*ProdFactor*LeptonUSquared;
						  fSumGood[fCouplingIndex][fMassIndex-1] += Weight;
						}
					      }
					    }
					  }
...
void HeavyNeutrinoTotalScan::EndOfJobUser() {
  ...
  for (Int_t i = 0; i < fNcoupling; i++) {
    for (Int_t j = 0; j < fNmass; j++) {
      fAcc[i][j] = fSumGood[i][j]/fSumAll[i][j];
      fProb[i][j] = fSumAll[i][j]/fNevents[i][j];
      fYield[i][j] = fAcc[i][j]*fProb[i][j];
    }
  }
...
Double_t HeavyNeutrinoTotalScan::ComputeHNLMass(KinePart* p) {
...
Double_t HeavyNeutrinoTotalScan::ComputeL(TVector3 p1, TVector3 p2, TVector3 mom1) {
...
Double_t HeavyNeutrinoTotalScan::ComputeNDecayProb(KinePart* p, Double_t tau, Double_t l) {
...
Double_t HeavyNeutrinoTotalScan::ComputeNReachProb(KinePart* p, Double_t tau, Double_t l) {
...
Double_t HeavyNeutrinoTotalScan::PhaseSpace(Double_t Mass1, Double_t Mass2, Double_t Mass3) {
...
Double_t HeavyNeutrinoTotalScan::PhaseSpaceFactor(Double_t Mass1, Double_t Mass2, Double_t Mass3) {
...
Double_t HeavyNeutrinoTotalScan::TwoBodyBR(Double_t Mass1, Double_t Mass2, Double_t Mass3, Int_t Dorigin, Bool_t noU) {
...
Double_t HeavyNeutrinoTotalScan::ThreeBodyBR(Double_t Mass1, Double_t Mass2, Double_t Mass3, Double_t Mass4, Int_t Dorigin, Bool_t noU) {
...
std::string HeavyNeutrinoTotalScan::ThreeBodyFunction(Double_t Mass1, Double_t Mass3) {
...
Double_t HeavyNeutrinoTotalScan::Gamma2(Double_t Mass1, Double_t Mass2, Double_t Mass3, Double_t form, Bool_t noU) {
...
Double_t HeavyNeutrinoTotalScan::GammaLeptonNu3(Double_t Mass1, Double_t Mass2, Double_t Mass3, Bool_t noU) {
...
Double_t HeavyNeutrinoTotalScan::GammaTot(Double_t MN) {
...
Double_t HeavyNeutrinoTotalScan::tauN(Double_t MN) {
...
Double_t HeavyNeutrinoTotalScan::lambda(Double_t a, Double_t b, Double_t c) {
...
Double_t HeavyNeutrinoTotalScan::ComputeProd(KinePart* p, Double_t MN) {
...
Double_t HeavyNeutrinoTotalScan::ComputeDecay(Double_t MN) {
