...
#include "HeavyNeutrinoScanNew.hh"
...
HeavyNeutrinoScanNew::HeavyNeutrinoScanNew(Core::BaseAnalysis *ba) :
  Analyzer(ba, "HeavyNeutrinoScanNew") {
  ...
  AddParam("CouplingStep", &fCouplingStep, 2.); // 0.1
...
void HeavyNeutrinoScanNew::InitOutput() {
...
void HeavyNeutrinoScanNew::InitHist() {
  ...
  if (fReadingData) {
    ...
    ImportAllInputHistogram("HeavyNeutrinoScanNew/SingleValue", false, "SingleValue");
    ImportAllInputHistogram("HeavyNeutrinoScanNew/CouplingScan", false, "CouplingScan");
    ImportAllInputHistogram("HeavyNeutrinoScanNew/MassScan", false, "MassScan");
    ImportAllInputHistogram("HeavyNeutrinoScanNew/ToyMC/DS", false, "ToyMC/DS");
    ImportAllInputHistogram("HeavyNeutrinoScanNew/ToyMC/D0", false, "ToyMC/D0");
...
void HeavyNeutrinoScanNew::Process(Int_t) {
...
void HeavyNeutrinoScanNew::EndOfJobUser() {
...
void HeavyNeutrinoScanNew::CosmeticsGraph(TGraph* g, const char* x, const char* y, Int_t col) {
...
void HeavyNeutrinoScanNew::CosmeticsGraph(TGraphAsymmErrors* g, const char* x, const char* y, Int_t col) {
...
void HeavyNeutrinoScanNew::EvaluateUL(TH2* h, TGraph* gr) {
...
std::vector<TGraph*> HeavyNeutrinoScanNew::ExtractContours(TH2* h) {
...
void HeavyNeutrinoScanNew::SumGraphs(TGraphAsymmErrors* res, TGraphAsymmErrors* g1, TGraphAsymmErrors* g2) {
