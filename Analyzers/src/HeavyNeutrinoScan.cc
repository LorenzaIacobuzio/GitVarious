...
void HeavyNeutrinoScan::CosmeticsHisto(TH1* h, const char* x, const char* y, Int_t col) {
...
void HeavyNeutrinoScan::Normalize(TH1D* h1, TH1D* h2, TString title, TString name, TString path) {
