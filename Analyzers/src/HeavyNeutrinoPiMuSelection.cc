...
void HeavyNeutrinoPiMuSelection::Process(Int_t) {
  ...
  if (GetWithMC()) {
	...
	if (counter == 2) {
	  FillHisto("hMomPi",  mom1.P()/1000.);
	  FillHisto("hMomMu",  mom2.P()/1000.);
	  FillHisto("hP1vsP2", mom1.P()/1000., mom2.P()/1000.);
...
void HeavyNeutrinoPiMuSelection::EndOfJobUser() {
  ...
  fhBeamlineDistvsTargetDist_TotMomInitial             ->GetYaxis()->SetTitle("Beamline distance [m]");
  fhBeamlineDistvsTargetDist_TotMomAfterDownstreamTrack->GetYaxis()->SetTitle("Beamline distance [m]");
  fhBeamlineDistvsTargetDist_TotMomAfterEnergyCuts     ->GetYaxis()->SetTitle("Beamline distance [m]");
  fhBeamlineDistvsTargetDist_TotMomAfterGeomCuts       ->GetYaxis()->SetTitle("Beamline distance [m]");
  fhBeamlineDistvsTargetDist_TotMomAfterVetoes         ->GetYaxis()->SetTitle("Beamline distance [m]");
  fhBeamlineDistvsTargetDist_TotMomFinal               ->GetYaxis()->SetTitle("Beamline distance [m]");
