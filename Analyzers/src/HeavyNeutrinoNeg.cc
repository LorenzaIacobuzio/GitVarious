...
void HeavyNeutrinoNeg::InitOutput() {
  ...
  if (fReadingData) {
    ...
    AddBranch("HeavyNeutrinoNegPassed", "threeMomPi", &threeMomPi);
    AddBranch("HeavyNeutrinoNegPassed", "threeMomMu", &threeMomMu);
    ...
    AddBranch("HeavyNeutrinoNegPassed", "KTAGcand", KTAGcand);
  }
  else {
