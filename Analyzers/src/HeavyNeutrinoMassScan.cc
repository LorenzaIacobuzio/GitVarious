...
/// \Brief                                                                                             
/// Scan on the mass of the heavy neutral leptons. It includes selection, weight and yield computation
...
/// (including acceptance and yield) are produced as functions of the HNL mass.                         
