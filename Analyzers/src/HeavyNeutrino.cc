...
void HeavyNeutrino::InitOutput() {
  ...
  if (fReadingData) {
    ...
    AddBranch("HeavyNeutrinoPassed", "BeamCDA1", &BeamCDA1);
    AddBranch("HeavyNeutrinoPassed", "BeamCDA2", &BeamCDA2);
    AddBranch("HeavyNeutrinoPassed", "BeamVtx1", &BeamVtx1);
    AddBranch("HeavyNeutrinoPassed", "BeamVtx2", &BeamVtx2);
    AddBranch("HeavyNeutrinoPassed", "EtotLKr", &EtotLKr);
    AddBranch("HeavyNeutrinoPassed", "Mom1", &Mom1);
    AddBranch("HeavyNeutrinoPassed", "Mom2", &Mom2);
    AddBranch("HeavyNeutrinoPassed", "Pos1", &Pos1);
    AddBranch("HeavyNeutrinoPassed", "Pos2", &Pos2);
    ...
    AddBranch("HeavyNeutrinoPassed", "nCHOD", &nCHOD);
    AddBranch("HeavyNeutrinoPassed", "nNewCHOD", &nNewCHOD);
    AddBranch("HeavyNeutrinoPassed", "nLKr", &nLKr);
    AddBranch("HeavyNeutrinoPassed", "RICHInfo1", &RICHInfo1);
