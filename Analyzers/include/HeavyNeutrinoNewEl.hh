...
#ifndef HEAVYNEUTRINONEWEL_HH
#define HEAVYNEUTRINONEWEL_HH
...
class HeavyNeutrinoNewEl : public NA62Analysis::Analyzer {

public:

  HeavyNeutrinoNewEl(NA62Analysis::Core::BaseAnalysis *ba);
  ~HeavyNeutrinoNewEl() {}
  void InitHist();
  void InitOutput();
  void DefineMCSimple() {}
