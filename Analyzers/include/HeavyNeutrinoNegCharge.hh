...
#ifndef HEAVYNEUTRINONEGCHARGE_HH
#define HEAVYNEUTRINONEGCHARGE_HH
...
class HeavyNeutrinoNegCharge : public NA62Analysis::Analyzer {

public:

  HeavyNeutrinoNegCharge(NA62Analysis::Core::BaseAnalysis *ba);
  ~HeavyNeutrinoNegCharge() {}
  void InitHist();
  void InitOutput();
  void DefineMCSimple() {}
  void Process(Int_t);
