...
#ifndef HEAVYNEUTRINOSCANNEWTAU_HH
#define HEAVYNEUTRINOSCANNEWTAU_HH
...
class HeavyNeutrinoScanNewTau : public NA62Analysis::Analyzer {

public:

  HeavyNeutrinoScanNewTau(NA62Analysis::Core::BaseAnalysis *ba);
  ~HeavyNeutrinoScanNewTau() {}
  void InitHist();
  void InitOutput();
  void DefineMCSimple() {}
  void Process(Int_t);
