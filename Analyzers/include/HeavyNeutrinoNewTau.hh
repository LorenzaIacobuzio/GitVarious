...
#ifndef HEAVYNEUTRINONEWTAU_HH
#define HEAVYNEUTRINONEWTAU_HH
...
class HeavyNeutrinoNewTau : public NA62Analysis::Analyzer {

public:

  HeavyNeutrinoNewTau(NA62Analysis::Core::BaseAnalysis *ba);
  ~HeavyNeutrinoNewTau() {}
  void InitHist();
  void InitOutput();
  void DefineMCSimple() {}
