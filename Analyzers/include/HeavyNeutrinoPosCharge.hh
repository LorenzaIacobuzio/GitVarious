...
#ifndef HEAVYNEUTRINOPOSCHARGE_HH
#define HEAVYNEUTRINOPOSCHARGE_HH
...
class HeavyNeutrinoPosCharge : public NA62Analysis::Analyzer {

public:

  HeavyNeutrinoPosCharge(NA62Analysis::Core::BaseAnalysis *ba);
  ~HeavyNeutrinoPosCharge() {}
  void InitHist();
  void InitOutput();
  void DefineMCSimple() {}
  void Process(Int_t);
